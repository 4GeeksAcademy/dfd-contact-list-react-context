        ...
        <div className="container">
            <div className='form-container'>
                <div className="d-flex align-items-center justify-content-center mb-4">
                    <i className="fas fa-user-edit fa-2x me-3 text-primary"></i>
                    <h2 className="mb-0">Editar Contacto</h2>
                </div>
                ...
                <form onSubmit={handleSubmit} className='contact-form'>
                    ...
                    <div className="mb-4">
                        ...
                        <input 
                            ...
                            onChange={handleChange}
                        />
                        <div className="form-text">Si no proporcionas una imagen, se mantendrá la actual</div>
                    </div>
